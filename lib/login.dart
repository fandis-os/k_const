      ...
      if(status=='fail'){
        ...
        if(dataUser['status_user']=='2'){
          ...
          setState(() async {
            ...
            prefs.setString('islogin', 'yes');
            prefs.setString('status', dataUser['status_user']);
            prefs.setString('id_ruas', dataUser['id_ruas']);
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Login K-cons", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blueGrey),),
              ...
              Center(
                child: Text("Copyright " + f.format(DateTime.now()) + " \u00a9 k_const - team teknik", style: TextStyle(fontSize: 11, color: Colors.blueGrey)),
              )
            ],
          ),
        )
